...
public static class SimplePool
{
    ...
    public static T Spawn<T>(T prefab, bool isActive = true) where T : MonoBehaviour
    {
        return Spawn(prefab, Vector3.zero, Quaternion.identity, isActive);
    }

    public static T Spawn<T>(T prefab, Vector3 pos, Quaternion rot, bool isActive = true) where T : MonoBehaviour
    {
